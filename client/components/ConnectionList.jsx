                    ...
                    switch (c.type) {
                        case 'steam':
                            return <Connection href={`http://steamcommunity.com/profiles/${c.id}`} name={c.name}
                                               icon={faSteam}/>
                        case 'twitch':
                            return <Connection href={`https://www.twitch.tv/${c.name}`} name={c.name} icon={faTwitch}/>
                        case 'youtube':
                        ...
                        case 'reddit':
                            return <Connection href={`https://reddit.com/u/${c.name}`} name={c.name} icon={faReddit}/>
                        case 'facebook':
                        ...
                        case 'spotify':
                            return <Connection href={`https://open.spotify.com/user/${c.id}`} name={c.name}
                                               icon={faSpotify}/>
                        case 'xbox':
                            return <Connection name={c.name} icon={faXbox}/>
                        default:
                            return <Connection name={c.name} icon={faBattleNet}/>
                    }
                })
            }
        </FixedHeightList>
